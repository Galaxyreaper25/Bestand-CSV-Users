...
$PrinterSharename = "Eerste Printer Share name"
...
Write-Host -ForegroundColor green -Object "De printer wordt ingesteld en aan het domein toegevoegd!"
...
# Commando's om de printer te netwerksharen
Write-Host -ForegroundColor Green -Object "De Printer zal nu gedeeld worden op het netwerk!"
Set-Printer -Name $NieuweNaam -Shared $true -ShareName $PrinterSharename

# Commando om het betreffende zip bestand weer te verwijderen
Write-Host -ForegroundColor green -Object "De tijdelijke pirnter bestanden zijn er weer uitgehaald scheelt u weer werk!"
Remove-Item -Path $PrinterdestZip -Recurse
 
# Active Directoy installeren en de DC aan het domein toevoegen
Write-Host -ForegroundColor green -Object "De DC wordt aan het domein toegevoegd!"
